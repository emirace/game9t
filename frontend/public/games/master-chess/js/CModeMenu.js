function CModeMenu() {
  ...
  this._init = function () {
    ...
    _oToggleEasy = new CToggle(
      CANVAS_WIDTH / 2 - 130 + 2,
      iYOffset,
      oSprite,
      false,
      s_oStage
    );
    _oToggleEasy.addEventListenerWithParams(
      ON_MOUSE_UP,
      this._onDifficultyToggle,
      this,
      EASY_MODE
    );

    var oSprite = s_oSpriteLibrary.getSprite("toggle_medium");
    _oToggleMedium = new CToggle(
      CANVAS_WIDTH / 2 + 2,
      iYOffset,
      oSprite,
      true,
    ...
    _oToggleMedium.addEventListenerWithParams(
      ON_MOUSE_UP,
      this._onDifficultyToggle,
      this,
      MEDIUM_MODE
    ...
    _oToggleHard.addEventListenerWithParams(
      ON_MOUSE_UP,
      this._onDifficultyToggle,
      this,
      HARD_MODE
    ...
    _oButComputer.addEventListener(
      ON_MOUSE_UP,
  ...
  this._onExit = function () {
    console.log("i click exit");
    this.unload();
    s_oMain.gotoMenu();
  };

  this._onButHumanRelease = function () {
    console.log("i am in human mode");
    this.unload();
