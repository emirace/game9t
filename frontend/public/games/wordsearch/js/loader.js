 ...
 */
 function initPreload(){
	...
	manifest=[
			...
			{src:'assets/button_solve.png', id:'buttonSolve'},
			...
			{src:'assets/item_player1.png', id:'itemPlayer1'},
			{src:'assets/item_player2.png', id:'itemPlayer2'},
			{src:'assets/item_number.png', id:'itemNumber'},
			{src:'assets/item_timer.png', id:'itemTimer'},
			{src:'assets/item_timer_player.png', id:'itemPlayerTimer'},
	...
	for(var n=0; n<categorySettings.length; n++){
		manifest.push({src:categorySettings[n].image, id:'category'+n})
	}
	...
	if(soundOn){
		...
		manifest.push({src:'assets/sounds/sound_status.ogg', id:'soundStatus'});
