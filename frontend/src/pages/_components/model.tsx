...
const Model: React.FC<ModelProps> = ({ children, isOpen, onClose }) => {
  ...
  return (
    isVisible && (
      <>
        <div
          className={`fixed top-1/2  translate-x-1/2 right-1/2 h-[75%] w-3/4 bg-light_blue rounded-md overflow-y-auto  p-4 md:p-6 transform transition-transform duration-300 ease-in-out ${
