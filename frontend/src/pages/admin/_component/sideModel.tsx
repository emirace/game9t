...
const SideModel: React.FC<SidebarProps> = ({ children, isOpen, onClose }) => {
  ...
  return (
    <>
      <div
        className={`fixed top-0 left-0 right-0 h-full w-full bg-dark transform transition-transform duration-300 ease-in-out ${
      ...
      >
        <img
          ...
          onClick={onClose}
          alt="close"
          className="w-4 h-4 absolute top-6 left-4 z-10"
        />
