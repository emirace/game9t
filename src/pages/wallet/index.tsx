...
const Wallet: React.FC = () => {
  ...
  return (
    <div className="bg-dark-900 text-white min-h-screen p-6 pb-40 md:px-20">
      ...
      {/* Current Balance */}
      <div className=" p-6 rounded-lg flex justify-center items-center gap-6">
      ...
      <div className="flex items-center justify-center space-x-4 mb-12">
        <button
          ...
          className="bg-black py-2 px-10 font-jua rounded-full"
        >
          Add Funds
        </button>
        <button
        ...
        <button className="bg-black py-2 px-10 font-jua rounded-full">
          Verify
        </button>
      </div>
        ...
        <table className="min-w-full table-auto rounded-lg">
          <thead>
            <tr className="bg-dark text-white text-left">
              ...
              <th className="p-4 font-jua">Transaction Type</th>
      ...
      {/* Pagination */}
      <div className="flex justify-between items-center mt-6 text-white px-20">
